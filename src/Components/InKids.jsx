...
function InKids({ cartItems, setCartItems }) {
 ...
 const handleBuyNow = () => {
  ...
  // Example additional views (optional images for side/back)
  const views = [
  ...
  // Kids’ sizes (you can customize for your age range)
  const sizes = ["2Y", "4Y", "6Y", "8Y", "10Y", "12Y"];

  return (
    <>
      <section className="category-section inkids-detail">
        <div className="category-row">
          ...
          {/* ✅ Product Info */}
          <div className="product-info inkids-info">
